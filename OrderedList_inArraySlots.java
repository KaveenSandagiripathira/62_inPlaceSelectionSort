...
public class OrderedList_inArraySlots
    ...
    /** 
	  ...
	  referred to by unordered from 
	  minIndex to the end of the array. 
     */
     private int champIndex(ArrayList<Integer> unordered, int minIndex) {
		 Integer champ = Integer.MAX_VALUE;
		 for (int index = minIndex; index < unordered.size(); index++){
			 if (unordered.get(index) < champ){
				 minIndex = index;
				 champ = unordered.get(index);
			 }
		 }
		 return minIndex;
     }
